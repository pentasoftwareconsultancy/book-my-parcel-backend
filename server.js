...
const startServer = async () => {
  try {
    ...
    server.listen(PORT, () => {
      ...
      const DB_TYPE = process.env.DATABASE_URL ? "Supabase" : "Local PostgreSQL";
      const envLabel = NODE_ENV === "production" ? "☁️ PRODUCTION" : "📱 DEVELOPMENT";
      ...
      console.log(`📱 SMS: ${smsEnabled ? "ENABLED ✅" : "DISABLED (logged to console)"}`);
