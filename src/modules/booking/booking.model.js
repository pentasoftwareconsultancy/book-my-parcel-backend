...
const Booking = sequelize.define("booking", {
  ...
  status: { type: DataTypes.ENUM("CREATED","MATCHING","CONFIRMED","PICKUP","IN_TRANSIT","PAYMENT_PENDING","DELIVERED","CANCELLED"), defaultValue: "CREATED" },
  ...
  payment_mode: { type: DataTypes.ENUM('PAY_NOW', 'PAY_AFTER_DELIVERY'), defaultValue: 'PAY_NOW', comment: 'Whether payment is done upfront or after delivery' },
}, {
