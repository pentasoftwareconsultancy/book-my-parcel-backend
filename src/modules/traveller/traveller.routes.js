...
import { validateKYC , validateStatus, validateAddRoute, validateUpdateRoute } from "../../utils/validation.util.js";
...
// Route management
router.post("/routes", authMiddleware, validateAddRoute, ctrl.createRoute);
router.get("/routes", authMiddleware, ctrl.getMyRoutes);
router.get("/routes/:id", authMiddleware, ctrl.getRouteById);
router.put("/routes/:id", authMiddleware, validateUpdateRoute, ctrl.updateRoute);
